...
export default function Gallery4Section() {
  return (
        ...
        <Card className="relative flex flex-row items-center gap-6 rounded-[2rem] border-white/20 bg-white/80 p-6 shadow-[0_30px_90px_-40px_rgba(15,23,42,0.6)] backdrop-blur-xl w-full max-w-[760px]">
          ...
          <CardContent className="relative flex-1 p-0">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Film pertama kita jatuhnya horror. Tapi anehnya, yang paling bikin
              deg-degan bukan di layar… melainkan karena ada kamu di sebelahku.
            </p>
          </CardContent>
        </Card>
      </div>
